...
test_group_bp = Blueprint('test_group_bp', __name__)


@test_group_bp.route('/create_test/<int:group_id>', methods=["PUT", "POST", "DELETE"])
...
@test_group_bp.route('/filter_test_datas/<int:group_id>', methods=["GET", "POST"])
...
@test_group_bp.route('/filter_test_group/<int:group_id>', methods=['POST'])
...
@test_group_bp.route('/submit_test_group/<int:group_id>', methods=["POST"])
@swag_from({'tags': ['Group'], "methods": ["POST"]})
@jwt_required()
